...
public class TourPackageController {
    ...
    private List<TourPackage> getSampleTours() {
        ...
        list.add(make(1L, "Goa Beach Trip", "Goa", "Goa", 15000, "beach",
        ...
        list.add(make(2L, "Coorg Hills Trip", "Coorg", "Karnataka", 12000, "hills",
        ...
        list.add(make(3L, "Gokarna Beach Camp", "Gokarna", "Karnataka", 9000, "beach",
        ...
        list.add(make(4L, "Mysore Palace Tour", "Mysore", "Karnataka", 8000, "heritage",
        ...
        list.add(make(5L, "Hampi Heritage Walk", "Hampi", "Karnataka", 10000, "heritage",
        ...
        list.add(make(6L, "Munnar Tea Hills", "Munnar", "Kerala", 14000, "hills",
        ...
        list.add(make(7L, "Alleppey Houseboat", "Alleppey", "Kerala", 16000, "backwater",
        ...
        list.add(make(8L, "Ooty Lake & Hills", "Ooty", "Tamil Nadu", 11000, "hills",
        ...
        list.add(make(9L, "Kodaikanal Escape", "Kodaikanal", "Tamil Nadu", 10500, "hills",
        ...
        list.add(make(10L, "Madurai Temple Tour", "Madurai", "Tamil Nadu", 7500, "temple",
        ...
        list.add(make(11L, "Tirupati Darshan", "Tirupati", "Andhra Pradesh", 7000, "temple",
        ...
        list.add(make(12L, "Araku Valley Trip", "Araku", "Andhra Pradesh", 9500, "valley",
